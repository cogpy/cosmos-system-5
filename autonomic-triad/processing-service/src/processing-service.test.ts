...
const cfg: ServiceConfig = { port:3024, serviceName:'processing-service', triadType:'autonomic', serviceType:'P-5', environment:'test' };
describe('ProcessingService (P-5) — autonomic [5-4]', () => {
